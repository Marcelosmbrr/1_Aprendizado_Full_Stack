...
// ==== Importação do componente roteamento ==== //
...
export function Registro() {
        ...
        //Enviar o código/link de confirmação para o email do novo usuário
          ...
          Jquery.ajax({
            ...
            beforeSend: function(){ console.log("PROCESSANDO REGISTRO"); } //Antes de enviar..
              ...
              ServerResponseTreatment({operation: "REGISTRATION", status: response.status, error: response.error, message: response.message});
  ...
  function ServerResponseTreatment(data){
    ...
    if(data.status){
      ...
      data.tittle = "Sucesso!";
      data.text = "Cadastro realizado com sucesso!";
      data.animation = <SuccessAnimation />

    }else{

      data.tittle = "Erro!";
      data.text = "Falha no cadastro!";
